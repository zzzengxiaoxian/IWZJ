...
public class AudioNews extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audionews);
...
//        webView.setScrollBarStyle(0);//滚动条风格，为0指滚动条不占用空间，直接覆盖在网页上
        webView.loadUrl("https://m.ximalaya.com/album-tag/news");//http://www.ximalaya.com/dq/news/   https://m.ximalaya.com/album-tag/news

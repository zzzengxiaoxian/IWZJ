 ...
 */
public class AudioLectureRoom extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audiolecture);
        ...
        msg.setText("努力加载中");
        webView= (WebView) findViewById(R.id.webviewrlecture);
...
//        webView.getSettings().setBlockNetworkImage(true);
        ...
        webView.loadUrl("https://m.ximalaya.com/album-tag/baijiajiangtan");
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            @Override     /*自定义页面加载progress*/
            public void onProgressChanged(WebView view, int newProgress) {
                //get the newProgress and refresh progress bar

            }
            @Override        /*获取当前页面正在加载那个页面title*/
